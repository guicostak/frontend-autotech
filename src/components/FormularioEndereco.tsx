...
export default function FormularioEndereco() {
  const { loading, error, handleSubmit, formData, errors, handleChange, handleEstadoChange, isEditing, toggleEditing,
    validateFieldBlur, perfilIncompleto, handlePaste
   } = useEndereco();;
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="px-16 py-7 flex flex-col bg-white h-auto w-2/3 rounded-lg shadow-lg relative">
